    ...
    <div>
        ...
        echo APP_NAME;
                ...
                <div id="search" class="hide hide2">                    
                        <a href="search.php">
                            <input type="button" name="search" id="search" class="btn btn-success" value="click to search"><img class="imgsearch" src="images/search.png" id="searchicon">  
                        </a>                  
                </div>
                <div id="about">
                    <ul>
                        ...
                        <li ><a href="signin.php" class="space" id="signin">Sign.In</a></li>
                        <button type="button" id="button" class="hide"><a href="register.php" id="button2">Register</a></button>
                    </ul>
                </div>
            </nav>